...
#===========================================================
# Transformation to Normality: Successful case 1
#===========================================================
...
#===========================================================
# Transformation to Normality: Successful case 2
#===========================================================
...
#===========================================================
# Transformation to Normality: Unsuccessful case
#===========================================================
...
X1<-mvrnorm(n=1000,c(5,9),Sigma1,empirical=TRUE)
S<-var(X1)
SA(X1)
